...
<table  border=0 width=700 cellpadding=4 cellspacing=0 align="center">
<thead>
<tr bgcolor="#66B3FF">
<th>No.</th>
<th width=120>NIM</th>
...
$id = $row[0]; ?>
<tbody>
<tr class="<?php echo $bg;?>" bgcolor="#E8E8E8">
...
<?php echo $id;?>"> <i class="icon-pencil"></i>
...
<div style="margin: 5px auto 0px 335px;"><a href="<?php echo $root;?>&amp;act=add"> <i class ="icon-plus"></i>Tambah Data</a></div> </div>
...
<table border=1 cellpadding=4 cellspacing=0 style="margin : 0px auto 0px 10px;">
<tr>
<td width=100>NIM*</td>
...
<tr>
<td> </td>
<td><input class="btn btn-success" type="submit" value="Submit" />
